...
// SetTokenHash sets the "token_hash" field.
func (u *SessionUpsert) SetTokenHash(v []byte) *SessionUpsert {
...
func (u *SessionUpsert) AddCreatedAt(v int64) *SessionUpsert {
	u.Add(session.FieldCreatedAt, v)
	return u
}
...
// SetTokenHash sets the "token_hash" field.
func (u *SessionUpsertOne) SetTokenHash(v []byte) *SessionUpsertOne {
...
// AddCreatedAt adds v to the "created_at" field.
func (u *SessionUpsertOne) AddCreatedAt(v int64) *SessionUpsertOne {
	return u.Update(func(s *SessionUpsert) {
		s.AddCreatedAt(v)
	})
}
...
// SetTokenHash sets the "token_hash" field.
func (u *SessionUpsertBulk) SetTokenHash(v []byte) *SessionUpsertBulk {
	return u.Update(func(s *SessionUpsert) {
		s.SetTokenHash(v)
	})
}
...
// AddCreatedAt adds v to the "created_at" field.
func (u *SessionUpsertBulk) AddCreatedAt(v int64) *SessionUpsertBulk {
	return u.Update(func(s *SessionUpsert) {
		s.AddCreatedAt(v)
	})
}
