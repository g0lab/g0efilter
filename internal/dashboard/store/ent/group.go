...
func (e GroupEdges) InstancesOrErr() ([]*Instance, error) {
	if e.loadedTypes[0] {
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldID, group.FieldName, group.FieldPolicy, group.FieldFilterMode:
...
// QueryInstances queries the "instances" edge of the Group entity.
func (_m *Group) QueryInstances() *InstanceQuery {
	return NewGroupClient(_m.config).QueryInstances(_m)
}
