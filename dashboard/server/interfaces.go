...
type LogStore interface {
	...
	Browse(ctx context.Context, p model.BrowseParams) (model.BrowsePage, error)
	Aggregate(ctx context.Context, p model.AggregateParams) (model.AggregateResult, error)
