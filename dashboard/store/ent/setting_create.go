...
func (_c *SettingCreate) SetValue(v []byte) *SettingCreate {
...
func (_c *SettingCreate) createSpec() (*Setting, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.Value(); ok {
		_spec.SetField(setting.FieldValue, field.TypeBytes, value)
		_node.Value = value
	}
	return _node, _spec
}
...
// SetValue sets the "value" field.
func (u *SettingUpsert) SetValue(v []byte) *SettingUpsert {
...
// SetValue sets the "value" field.
func (u *SettingUpsertOne) SetValue(v []byte) *SettingUpsertOne {
	return u.Update(func(s *SettingUpsert) {
		s.SetValue(v)
	})
}
...
// SetValue sets the "value" field.
func (u *SettingUpsertBulk) SetValue(v []byte) *SettingUpsertBulk {
	return u.Update(func(s *SettingUpsert) {
		s.SetValue(v)
	})
}
