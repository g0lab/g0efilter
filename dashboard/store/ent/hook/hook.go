...
// The CompletedUnblockFunc type is an adapter to allow the use of ordinary
// function as CompletedUnblock mutator.
type CompletedUnblockFunc func(context.Context, *ent.CompletedUnblockMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CompletedUnblockFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.CompletedUnblockMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CompletedUnblockMutation", m)
}
...
// The UnblockRequestFunc type is an adapter to allow the use of ordinary
// function as UnblockRequest mutator.
type UnblockRequestFunc func(context.Context, *ent.UnblockRequestMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f UnblockRequestFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UnblockRequestMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.UnblockRequestMutation", m)
}
